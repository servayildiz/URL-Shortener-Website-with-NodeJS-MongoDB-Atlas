...
! function(a) {
    ...
    function b(c, d) {
        var e = function() {},
            ...
            g = {
                ...
                onSearchComplete: e,
                onSearchError: e,
                containerClass: "teach_coders_ul",
                tabDisabled: !1,
                dataType: "text",
                currentRequest: null,
        ...
        f.element = c, f.el = a(c), f.suggestions = [], f.badQueries = [], f.selectedIndex = -1, f.currentValue = f.element.value, f.intervalId = 0, f.cachedResponse = {}, f.onChangeInterval = null, f.onChange = null, f.isLocal = !1, f.suggestionsContainer = null, f.noSuggestionsContainer = null, f.options = a.extend({}, g, d), 
        f.classes = {
            //selected: "autocomplete-selected",
            suggestion: "teach_coders_li"
        },
    ...
    b.utils = c, a.Autocomplete = b, b.formatResult = function(a, b) {
        ...
        initialize: function() {
            ...
            }, d.noSuggestionsContainer = a('<li></li>').html(this.options.noSuggestionNotice).get(0), d.suggestionsContainer = b.utils.createNode(g.containerClass), c = a(d.suggestionsContainer), c.appendTo(g.appendTo), "auto" !== g.width && c.width(g.width), c.on("mouseover.autocomplete", e, function() {
        ...
        suggest: function() {
            ...
            var b, c, d = this,
                ...
                o = function(a) {
                    var c = a.data[f];
                    return b === c ? "" : (b = c, '<b class="autocomplete-group"><strong>' + b + "</strong></b>")
                };

            return e.triggerSelectOnValidInput && (c = d.findSuggestionIndex(h), -1 !== c) ? void d.select(c) : (a.each(d.suggestions, 

            	function(a, b) {
                f && (n += o(b, h, a)), n += '<li class="' + i + '" data-index="' + a + '">' + g(b, h) + "</li>"
